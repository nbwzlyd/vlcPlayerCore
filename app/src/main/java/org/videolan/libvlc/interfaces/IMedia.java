...
public interface IMedia extends IVLCObject<IMedia.Event> {
    class Event extends org.videolan.libvlc.interfaces.AbstractVLCEvent {
    ...
    abstract class Track {
        ...
        protected Track(int type, String id, String name, boolean selected, String codec, String originalCodec, int fourcc, int profile, int level, int bitrate, String language, String description) {
            this.type = type;
            this.id = id;
            this.name = name;
    ...
    class AudioTrack extends Track {
        ...
        public AudioTrack(String id, String name, boolean selected, String codec, String originalCodec, int fourcc, int profile, int level, int bitrate, String language, String description, int channels, int rate) {
    ...
    class VideoTrack extends Track {
        ...
        public VideoTrack(String id, String name, boolean selected, String codec, String originalCodec, int fourcc, int profile, int level, int bitrate, String language, String description, int height, int width, int sarNum, int sarDen, int frameRateNum, int frameRateDen, int orientation, int projection) {
    ...
    class SubtitleTrack extends Track {
        ...
        public SubtitleTrack(String id, String name, boolean selected, String codec, String originalCodec, int fourcc, int profile, int level, int bitrate, String language, String description, String encoding) {
    ...
    class UnknownTrack extends Track {
        public UnknownTrack(String id, String name, boolean selected, String codec, String originalCodec, int fourcc, int profile, int level, int bitrate, String language, String description) {
