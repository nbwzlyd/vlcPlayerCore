...
public interface IMediaList extends IVLCObject<IMediaList.Event> {
    class Event extends org.videolan.libvlc.interfaces.AbstractVLCEvent {
         ...
         * attributes are still available (like {@link org.videolan.libvlc.interfaces.IMedia#getUri()}}).
         */
        public final org.videolan.libvlc.interfaces.IMedia media;
        private final boolean retain;
        public final int index;

        public Event(int type, org.videolan.libvlc.interfaces.IMedia media, boolean retain, int index) {
            super(type);
